...
public class QuantityLabel extends LabelClass implements canReactMouseWheel, canReactMouseClick {

    private final Pattern valuePattern = Pattern.compile("[0-9]{1,2}");
    private String currentValue;
    private final String defaultFollowUpValue = "";
    ...
    public QuantityLabel(Application app, JPanel parent_to_add, String ID, String styleID, String text, ArrayList<LabelClass> allLabel){
